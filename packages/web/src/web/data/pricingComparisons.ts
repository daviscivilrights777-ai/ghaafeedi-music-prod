...
export const FILM_COMPARISON_BY_LENGTH: {
  ...
  ghaafeediByLength: [
    // 5 min
    [
      { name: "Essential", price: 149, features: ["Full film production", "AI scripting", "Original music", "Voiceover", "1 revision"] },
      { name: "Creator",   price: 249, features: ["Everything in Essential", "Priority production", "2 revisions", "4K delivery"] },
      { name: "Pro",       price: 399, features: ["Everything in Creator", "Full orchestral score", "4 revisions", "Physical keepsake"] },
    ],
    // 10 min
    [
  ...
  competitorsByLength: [
    ...
    [
      {
        ...
        missing: ["AI scripting", "Voiceover", "Music", "Revisions included", "Delivery guarantee"],
        note: "Credits only. VO, music, editing, and revisions cost extra.",
      },
      {
      ...
      },
      {
        ...
        includes: ["Premium cinematic video credits"],
        missing: ["AI scripting", "Voiceover", "Music", "Revisions included", "Delivery guarantee"],
        note: "Premium model. $10.75/clip. Most expensive DIY option.",
      },
      {
        ...
        includes: ["Video generation credits"],
        missing: ["AI scripting", "Voiceover", "Music", "Revisions included", "Delivery guarantee"],
        note: "Cheapest DIY but 40–60% rejection rate on cinematic shots.",
      },
    ],
    // 10 min
    [
      ...
      { name: "HiggsField Seedance 2.0", logo: "H", url: "https://higsfield.ai", color: "#A855F7",
        ...
        includes: ["Premium cinematic video credits"],
        missing: ["AI scripting", "Voiceover", "Music", "Revisions included", "Delivery guarantee"],
        note: "Premium model. Credits alone: $1,935.",
      },
      { name: "Kling AI Pro", logo: "K", url: "https://klingai.com", color: "#059669",
        priceRange: "$375–$560", priceMin: 375, priceMax: 560,
        includes: ["Video generation credits"],
        missing: ["AI scripting", "Voiceover", "Music", "Revisions included", "Delivery guarantee"],
        note: "Still cheaper than Ghaafeedi Pro — but with none of the production.",
      },
    ],
    // 15 min
    [
    ...
    [
      { name: "Runway Gen-4", logo: "✈", url: "https://runwayml.com", color: "#4A90D9",
        ...
        includes: ["Video generation credits", "Basic editing"],
        missing: ["AI scripting", "Voiceover", "Music", "Revisions included", "Delivery guarantee"],
        note: "Credits only. VO, music, editing, revisions not included.",
      },
      { name: "HiggsField Kling 3.0", logo: "H", url: "https://higsfield.ai", color: "#7B5CF6",
      ...
      { name: "HiggsField Seedance 2.0", logo: "H", url: "https://higsfield.ai", color: "#A855F7",
        ...
        includes: ["Premium cinematic video credits"],
        missing: ["AI scripting", "Voiceover", "Music", "Revisions included", "Delivery guarantee"],
        note: "Most cinematic model. 10× more expensive than Ghaafeedi.",
      },
      { name: "Kling AI Pro", logo: "K", url: "https://klingai.com", color: "#059669",
  ...
  savingsByLength: [
    { vsCheapest: "Save $51+",      vsMostExpensive: "Up to $1,651 saved", badge: "Save $51–$1,651 vs DIY" },
    { vsCheapest: "Save $76+",      vsMostExpensive: "Up to $3,201 saved", badge: "Save $76–$3,201 vs DIY" },
    { vsCheapest: "Save $101+",     vsMostExpensive: "Up to $4,751 saved", badge: "Save $101–$4,751 vs DIY" },
    { vsCheapest: "Save $120+",     vsMostExpensive: "Up to $6,301 saved", badge: "Save $120–$6,301 vs DIY" },
    { vsCheapest: "Save $140+",     vsMostExpensive: "Up to $7,851 saved", badge: "Save $140–$7,851 vs DIY" },
    { vsCheapest: "Save $160+",     vsMostExpensive: "Up to $9,401 saved", badge: "Save $160–$9,401 vs DIY" },
  ],
};
...
export const HEX_SAVINGS_BADGE: Record<string, string> = {
  "cinematic-life-story":   "Save $51–$3,201 vs DIY",
  "couples-journey-film":   "Save $51–$3,201 vs DIY",
  "memorial-legacy-film":   "Save $51–$3,201 vs DIY",
  "cinematic-story-film":   "Save $51–$1,651 vs DIY",
  "dream-ai-visualization": "Save $51–$1,651 vs DIY",
  "future-self-vision":     "Save $51–$1,651 vs DIY",
...
export const CHECKOUT_SAVINGS_LINE: Record<string, (price: number) => string | null> = {
  "cinematic-life-story":   (p) => `You'd pay $${(p + 233).toLocaleString()}–$${(p + 3201).toLocaleString()} doing this yourself on Runway or HiggsField`,
  "couples-journey-film":   (p) => `You'd pay $${(p + 233).toLocaleString()}–$${(p + 3201).toLocaleString()} doing this yourself on AI video platforms`,
  "memorial-legacy-film":   (p) => `You'd pay $${(p + 233).toLocaleString()}–$${(p + 3201).toLocaleString()} doing this yourself on AI video platforms`,
  "cinematic-story-film":   (p) => `You'd pay $${(p + 51).toLocaleString()}–$${(p + 1651).toLocaleString()} doing this yourself on Runway or Kling`,
  "dream-ai-visualization": (p) => `You'd pay $${(p + 51).toLocaleString()}–$${(p + 1651).toLocaleString()} doing this yourself on AI video platforms`,
  "future-self-vision":     (p) => `You'd pay $${(p + 51).toLocaleString()}–$${(p + 1651).toLocaleString()} doing this yourself on AI video platforms`,
