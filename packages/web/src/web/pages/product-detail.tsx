...
export const PRODUCTS: Record<string, Product> = {
  "sophia-ai": {
    ...
    image: "/assets/prod-sophia-portrait.webp",
  ...
  "cinematic-life-story": {
    ...
    image: "/assets/prod-cinematic-life-story.webp",
  ...
  "emotional-soundtrack": {
    ...
    image: "/assets/prod-emotional-soundtrack.webp",
  ...
  "voice-cloning-studio": {
    ...
    image: "/assets/prod-voice-cloning.webp",
  ...
  "memorial-legacy-film": {
    ...
    image: "/assets/prod-memorial-legacy.webp",
    category: "Memorial",
  ...
  "relationship-healing": {
    ...
    image: "/assets/prod-relationship-healing.webp",
  ...
  "family-vault": {
    ...
    image: "/assets/prod-family-vault.webp",
  ...
  "nft-collection": {
    ...
    image: "/assets/prod-nft-collection.webp",
  ...
  "signature-masterpiece": {
    ...
    image: "/assets/prod-signature-masterpiece.webp",
  ...
  "cinematic-story-film": {
    ...
    image: "/assets/prod-cinematic-story-film.webp",
    category: "Film Production",
  ...
  "couples-journey-film": {
    ...
    image: "/assets/prod-couples-journey.webp",
    category: "Film Production",
  ...
  "dream-ai-visualization": {
    ...
    image: "/assets/prod-dream-visualization.webp",
    category: "AI Visual",
  ...
  "future-self-vision": {
    ...
    image: "/assets/prod-future-self.webp",
  ...
  "social-ready-clips": {
    ...
    image: "/assets/prod-social-clips.webp",
