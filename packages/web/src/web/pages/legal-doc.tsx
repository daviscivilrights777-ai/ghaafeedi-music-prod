...
// Items marked ⚠️ NEEDS: [...] require real information from Lawrence before
// this document can be considered final. Search for "NEEDS:" to find all gaps.
// ─────────────────────────────────────────────────────────────────────────────
...
const DOCS: Record<string, LegalDoc> = {
  ...
  "terms-of-service": {
    ...
    sections: [
      {
        heading: "IMPORTANT — READ BEFORE USING",
        body: [
      ...
      },
      {
        ...
        body: [
          "2.1 CORE SERVICES\n\nGhaafeedi Music provides the following AI-powered creative services ("Services"):\n\n(a) EMOTIONAL STORY ANALYSIS: Using artificial intelligence to analyze the emotional themes, narrative arc, and lyrical potential of customer-submitted personal stories.\n\n(b) ORIGINAL SONG CREATION: Generating original song lyrics and complete musical compositions based on emotional analysis of customer stories, using proprietary AI systems.\n\n(c) MUSIC VIDEO PRODUCTION: Creating original cinematic AI-generated music videos synchronized to the generated song, featuring either:\n    (i)  AI-Generated Characters: Fictional AI-created characters whose appearance is derived from emotional themes of the customer's story;\n    (ii) Customer Likeness Characters: AI-assisted characters based on customer-submitted photographs, subject to separate consent requirements; or\n    (iii) Combined Characters: A combination of the above, available at additional cost.\n\n(d) CONTENT DELIVERY: Delivery of finished creative works via digital download or streaming link.",
          "2.2 SERVICE TIERS\n\nServices are offered in the following tiers:\n\nSong Memberships:\n• Starter — 3 songs/month — $49/month\n• Premium — 8 songs/month — $79/month\n• Elite — 15 songs/month — $125/month\n\nCinematic Songs (one-time):\n• Essential — 2 songs — $19\n• Creator — 5 songs — $39\n• Pro — 12 songs — $69\n\nMusic Videos (one-time, by duration):\n• 2-minute video — Basic $79 / Standard $129 / Premium $199\n• 4-minute video — Basic $89 / Standard $149 / Premium $229\n• 5-minute video — Basic $199 / Standard $349 / Premium $599\n• 10-minute video — Basic $299 / Standard $499 / Premium $799\n\nAdditional products are listed on the Ghaafeedi Music products page at ghaafeedimusic.com/products.",
      ...
      },
      {
        ...
        body: [
          ...
          "4.3 STORY CONFIDENTIALITY\n\nWe recognize that personal stories may contain sensitive information. We maintain strict confidentiality protocols for all submitted stories. However, we reserve the right to share story content:\n(a) As required by law, court order, or regulatory requirement\n(b) To prevent imminent harm to you or others\n(c) As described in our Privacy Policy",
          "4.4 MANDATORY REPORTING OBLIGATIONS\n\nIn certain circumstances, Ghaafeedi Music and its employees may have mandatory reporting obligations under applicable state law, including but not limited to:\n(a) Imminent threats of harm to self or others\n(b) Disclosures involving child abuse or neglect\n(c) Elder abuse in states with mandatory reporting laws\n\nIf your submission contains content triggering mandatory reporting obligations, we will comply with applicable law regardless of your consent.",
      ...
      },
      {
        ...
        body: [
          "5.1 OWNERSHIP OF DELIVERED CONTENT\n\nUpon full payment for your order, Ghaafeedi Music assigns to you all of its right, title, and interest, if any, in the delivered creative works specifically created for your order, including:\n(a) The generated song audio file\n(b) The generated lyrics\n(c) The generated music video file\n\nThis assignment is subject to the limitations and reservations set forth in these Terms.",
          "5.2 COPYRIGHT UNCERTAINTY DISCLOSURE\n\nIMPORTANT: As of the date of these Terms, the United States Copyright Office has stated that purely AI-generated content without sufficient human authorship may not be eligible for copyright registration. The amount of human creative contribution required for copyright protection is not yet definitively established by courts.\n\nGhaafeedi Music makes no warranty regarding the copyrightability of the delivered content. We strongly recommend that you:\n(a) Consult an intellectual property attorney regarding the copyright status of your content\n(b) Document the creative contributions you made (your story, emotional direction, thematic choices)\n(c) Remain informed of developments in AI copyright law",
          "5.3 LICENSE RETAINED BY GHAAFEEDI MUSIC\n\nNotwithstanding Section 5.1, Ghaafeedi Music retains:\n\n(a) TECHNOLOGY LICENSE: A perpetual, irrevocable license to use, improve, and develop the AI systems and methodologies used to create your content. This does not include the right to use your specific story or delivered content.\n\n(b) PORTFOLIO LICENSE: Subject to your separate written consent, a license to display your delivered content in Ghaafeedi Music's portfolio, marketing materials, and promotional contexts. This license is OPTIONAL and requires your separate affirmative consent. You will be asked separately whether you grant this license.\n\n(c) AGGREGATE ANALYTICS: The right to use aggregate, anonymized data about production processes for system improvement.",
          "5.4 MUSIC RIGHTS AND LICENSING\n\n(a) AI-GENERATED MUSIC: The musical compositions generated by Ghaafeedi Music AI systems do not contain samples of any pre-existing copyrighted musical works. We use original AI generation systems for all musical content.\n\n(b) POYO.AI GENERATED MUSIC: Music generated using Poyo.ai systems is subject to Poyo.ai's Terms of Service regarding commercial use. By accepting our Terms, you acknowledge that Poyo.ai's commercial use terms apply to music generated through their platform. We will provide specific notice for orders using Poyo.ai generation.\n\n(c) SELF-HOSTED GENERATION: Music generated using self-hosted open-source models (where applicable) is generated under the respective model licenses. We will provide model licensing information upon request.\n\n(d) PERFORMANCE RIGHTS ORGANIZATIONS: Your generated songs are not currently registered with any Performing Rights Organization (PRO) such as ASCAP, BMI, or SESAC. If you wish to commercially exploit your song, you should consult a music attorney regarding PRO registration.\n\n(e) STREAMING PLATFORMS: Policies on AI-generated music vary by streaming platform. Spotify, Apple Music, YouTube, and others have evolving policies. We make no warranty that your content will be accepted by any particular streaming or distribution platform.",
          ...
          "5.6 THIRD PARTY INTELLECTUAL PROPERTY\n\nYou must not submit stories containing:\n(a) Lyrics, poems, or written works owned by third parties\n(b) Requests to recreate specific copyrighted songs\n(c) Requests to imitate specific copyrighted artists' style in ways that would constitute infringement\n(d) Any content that would infringe third-party intellectual property rights",
        ],
      },
      {
        heading: "ARTICLE 6 — PAYMENT TERMS",
        body: [
          "6.1 PRICING AND PAYMENT\n\n(a) All prices are listed in United States Dollars (USD).\n(b) Payment is required in full before production begins.\n(c) We accept payment via credit card, debit card, Apple Pay, Google Pay, PayPal, bank transfer, and cryptocurrency where available.\n(d) Payment processing is handled by Dodo Payments and Whop, subject to their terms of service.\n(e) By providing payment information, you represent that you are authorized to use the payment method.",
          "6.2 REFUND POLICY\n\nFULL REFUND: A full refund will be issued if:\n(a) You cancel before production has begun (within 60 minutes of order placement)\n(b) We are unable to complete your order due to technical failure affecting the entire order\n(c) The delivered content is materially defective and we cannot correct it within two re-generation attempts\n\nPARTIAL REFUND: A partial refund (pro-rated based on completed portions) will be issued if:\n(a) Partial technical failure results in fewer than 75% of planned shots being successfully generated\n(b) Song generation succeeds but video generation fails completely (refund of video portion only)\n\nNO REFUND: No refund is available if:\n(a) Production is complete and content is delivered\n(b) You are dissatisfied with the aesthetic style, creative direction, or emotional interpretation\n(c) You provided incorrect or insufficient story information\n(d) You violate these Terms and your account is terminated\n(e) Cancellation is requested more than 60 minutes after order placement and production has begun",
      ...
      },
      {
        ...
        body: [
          "9.1 WARRANTY DISCLAIMER\n\nGHAAFEEDI MUSIC SERVICES ARE PROVIDED \"AS IS\" AND \"AS AVAILABLE\" WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO:\n\n(a) WARRANTIES OF MERCHANTABILITY\n(b) FITNESS FOR A PARTICULAR PURPOSE\n(c) NON-INFRINGEMENT\n(d) ACCURACY OR COMPLETENESS OF CONTENT\n(e) THAT THE SERVICE WILL BE UNINTERRUPTED OR ERROR-FREE\n(f) THAT DEFECTS WILL BE CORRECTED\n(g) THAT THE SERVICE IS FREE OF VIRUSES OR HARMFUL COMPONENTS\n(h) THAT AI-GENERATED CONTENT WILL MEET YOUR SPECIFIC AESTHETIC EXPECTATIONS\n(i) THAT AI-GENERATED CONTENT IS COPYRIGHTABLE OR COMMERCIALLY EXPLOITABLE",
          "9.2 LIMITATION OF LIABILITY\n\nTO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW:\n\n(a) GHAAFEEDI MUSIC'S TOTAL LIABILITY TO YOU FOR ALL CLAIMS ARISING OUT OF OR RELATED TO THESE TERMS OR THE SERVICES SHALL NOT EXCEED THE GREATER OF:\n    (i)  THE TOTAL AMOUNT PAID BY YOU TO GHAAFEEDI MUSIC IN THE TWELVE (12) MONTHS PRECEDING THE CLAIM; OR\n    (ii) ONE HUNDRED DOLLARS ($100.00)\n\n(b) IN NO EVENT SHALL GHAAFEEDI MUSIC BE LIABLE FOR:\n    (i)   INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES\n    (ii)  LOSS OF PROFITS, REVENUE, DATA, OR GOODWILL\n    (iii) COST OF SUBSTITUTE SERVICES\n    (iv)  EMOTIONAL DISTRESS NOT RESULTING FROM PHYSICAL INJURY (EXCEPT WHERE PROHIBITED BY LAW)\n    (v)   ANY DAMAGES ARISING FROM YOUR RELIANCE ON AI-GENERATED CONTENT",
          "9.3 EXCEPTIONS TO LIMITATIONS\n\nNOTHING IN THESE TERMS LIMITS LIABILITY FOR:\n(a) Death or personal injury caused by our negligence\n(b) Fraud or fraudulent misrepresentation\n(c) Violations of applicable consumer protection laws where such limitations are prohibited\n(d) Violations of the Illinois Biometric Information Privacy Act (740 ILCS 14/) where applicable\n(e) Any liability that cannot be limited under applicable law",
      ...
      },
      {
        ...
        body: [
          ...
          "11.2 BINDING ARBITRATION\n\nIF INFORMAL RESOLUTION FAILS, YOU AND GHAAFEEDI MUSIC AGREE THAT ANY DISPUTE, CLAIM, OR CONTROVERSY ARISING OUT OF OR RELATING TO THESE TERMS OR THE SERVICES WILL BE RESOLVED BY BINDING ARBITRATION RATHER THAN IN COURT, EXCEPT AS PROVIDED IN SECTION 11.4.\n\nArbitration Procedures:\n(a) Arbitration will be conducted by the American Arbitration Association (AAA) under its Consumer Arbitration Rules\n(b) Arbitration will take place in ⚠️ NEEDS: [STATE/COUNTY — your state of incorporation or primary business location] or via video conference at our election\n(c) The arbitration will be conducted in English\n(d) The arbitrator's decision will be final and binding\n(e) Each party will bear its own arbitration costs, except as required by AAA rules for consumer disputes\n(f) The arbitrator may award the same damages and relief that a court could award",
          ...
          "11.5 GOVERNING LAW\n\nThese Terms are governed by the laws of the State of ⚠️ NEEDS: [STATE OF INCORPORATION], without regard to conflict of law principles, except that the Federal Arbitration Act governs all arbitration provisions.",
          "11.6 JURISDICTION\n\nFor any matters not subject to arbitration, you consent to the exclusive jurisdiction of the state and federal courts located in ⚠️ NEEDS: [COUNTY, STATE — your primary business location].",
      ...
      },
      {
        ...
        body: [
          ...
          "12.2 TERMINATION BY GHAAFEEDI MUSIC\n\nWe may suspend or terminate your account immediately for:\n(a) Violation of these Terms\n(b) Conduct that we determine poses a risk to other users, third parties, or Ghaafeedi Music\n(c) Fraudulent activity\n(d) Non-payment\n(e) Regulatory or legal requirements\n(f) Upon request by law enforcement",
          "12.3 EFFECT OF TERMINATION\n\nUpon termination:\n(a) Your access to the service ceases immediately\n(b) Licenses granted to you terminate for future use but do not affect already-delivered content\n(c) We retain your information as required by law and as described in our Privacy Policy\n(d) Provisions of these Terms that by their nature should survive will survive termination",
        ],
      },
      {
        ...
        body: [
          ...
          "13.6 NOTICES\n\nNotices to Ghaafeedi Music must be sent to:\nLegal@ghaafeedimusic.com\n⚠️ NEEDS: [COMPANY MAILING ADDRESS]\n⚠️ NEEDS: [CITY, STATE, ZIP]",
  ...
  "privacy-policy": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "4.1 RETENTION SCHEDULE\n\nACCOUNT DATA:\n• Active accounts: Retained while account is active plus 3 years after account closure\n• Reason: Legal claims and dispute resolution\n\nORDER AND STORY DATA:\n• Retained for 2 years after order delivery\n• Reason: Quality assurance, dispute resolution\n• Stories may be anonymized after 90 days upon request\n\nBIOMETRIC DATA:\n• Retained for the shorter of: 3 years from consent date OR until deletion is requested OR until the purpose for collection is fulfilled plus 30 days\n• Reason: Illinois BIPA and similar state law requirements\n\nCONSENT RECORDS:\n• Retained for 5 years from signature date\n• Reason: Legal compliance and dispute defense\n\nAUDIT LOGS:\n• Security events: 7 years\n• Access logs: 3 years\n• Payment records: 7 years (IRS requirements)",
          "4.2 DELETION PROCESS\n\nWhen data is scheduled for deletion:\n• Data is securely overwritten using industry-standard methods\n• Deletion is logged in our compliance records\n• Third-party service providers are instructed to delete",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "7.3 CHILDREN UNDER 13\n\nWe do not knowingly collect personal information from children under 13. If we discover we have collected such information without verified parental consent, we will delete it immediately.\n\nIf you believe we have collected information from a child under 13, contact privacy@ghaafeedimusic.com immediately.",
      ...
      },
      {
        ...
        body: [
          "10.1 PRIVACY CONTACT\n\nData Controller: Ghaafeedi Music LLC\nPrivacy Officer: ⚠️ NEEDS: [NAME OR TITLE — e.g., \"Privacy Officer\" or a specific person's name]\nEmail: privacy@ghaafeedimusic.com\nAddress: ⚠️ NEEDS: [COMPANY MAILING ADDRESS]\nPhone: ⚠️ NEEDS: [BUSINESS PHONE NUMBER]",
    ...
    sections: [
      {
        heading: "OVERVIEW",
        body: [
          "This Acceptable Use Policy (\"AUP\") governs all content submitted to and generated by Ghaafeedi Music services.",
        ],
      },
      {
      ...
      },
      {
        ...
        body: [
          "4.1 CONTENT REVIEW\n\nAll submissions are reviewed by automated systems and may be reviewed by authorized human staff. We use a combination of:\n• AI content classification\n• Keyword and pattern detection\n• Random quality assurance review\n• User reports",
    ...
    sections: [
      {
        ...
        body: [
          "Ghaafeedi Music LLC has registered a designated agent with the United States Copyright Office pursuant to 17 U.S.C. § 512(c)(2).\n\nDESIGNATED COPYRIGHT AGENT:\nName: ⚠️ NEEDS: [DMCA AGENT NAME — must be a real person, e.g., Lawrence Davis or your attorney]\nCompany: Ghaafeedi Music LLC\nAddress: ⚠️ NEEDS: [PHYSICAL MAILING ADDRESS — required by law]\nEmail: dmca@ghaafeedimusic.com\nPhone: ⚠️ NEEDS: [BUSINESS PHONE NUMBER]\n\nIMPORTANT: The designated agent must be registered at copyright.gov/dmca-directory. Annual fee: $6. Required before launch — without registration, DMCA safe harbor protections may not apply.",
        ],
      },
      {
  ...
  "music-video-rights": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "3.1 POYO.AI GENERATED MUSIC\n\nFor orders processed using Poyo.ai music generation:\n\n(a) Poyo.ai's terms for paid subscribers govern commercial rights to generated content. However, Poyo.ai's terms may change and may be subject to ongoing developments in AI music law.\n\n(b) We will notify you if your order was generated using Poyo.ai upon request.\n\n(c) AI music copyright litigation is active (RIAA v. Suno, etc.). You should monitor developments in this area as they may affect the commercial usability of AI-generated content.",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "ACTION ITEM 1.3 — FOREIGN QUALIFICATION\nStatus: [ ] ASSESS  [ ] COMPLETE  [ ] NOT APPLICABLE\n\nRequirement: If doing substantial business in states other than your formation state, foreign qualification may be required. Assess with a business attorney.",
      ...
      },
      {
        ...
        body: [
          "Technology Business Attorney:\nFor: Entity formation, Terms of Service, general business law\nFind: State bar referral service, or search for technology startup attorneys in your area\n\nPrivacy Law Attorney (CIPP/US Certified):\nFor: BIPA compliance, CCPA compliance, Privacy Policy\nFind: International Association of Privacy Professionals (iapp.org) attorney directory\n\nEntertainment/Music Attorney:\nFor: Music rights strategy, PRO registration, AI music licensing\nFind: Volunteer Lawyers for the Arts, music attorney directories\n\nIntellectual Property Attorney:\nFor: Copyright strategy, DMCA, AI IP issues\nFind: United States Patent and Trademark Office attorney database\n\nInsurance Broker (Technology Specialty):\nFor: E&O, Cyber, General Liability packages\nFind: Ask your business attorney for referrals or search for \"technology E&O insurance broker\"",
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: [
          "All customer story submissions are automatically classified into the following risk categories:\n\nLEVEL 0 — STANDARD:\nNormal emotional content (love, joy, nostalgia, general life experiences). Standard processing.\n\nLEVEL 1 — SENSITIVE:\nGrief, heartbreak, moderate trauma, recovery stories. Standard processing with crisis resource inclusion in delivery.\n\nLEVEL 2 — ELEVATED CONCERN:\nReferences to depression, anxiety, suicidal ideation (historical/non-immediate), abuse survival, serious illness, major loss. Include crisis resources. Human review of content before delivery. Flag account for welfare check option.\n\nLEVEL 3 — IMMEDIATE CONCERN:\nLanguage indicating imminent self-harm, explicit suicidal intent, threats to others, active abuse disclosure, child safety concerns. HALT production. Human review within 1 hour. Follow mandatory reporting obligations. Contact emergency services if imminent danger.\n\nLEVEL 4 — ILLEGAL CONTENT:\nCSAM, terrorism, human trafficking content. HALT immediately. Do not process. Report to NCMEC (CSAM), FBI tip line, or appropriate law enforcement. Preserve all evidence.",
        ],
      },
      {
    ...
    sections: [
      {
        ...
        body: [
          "1.1 CURRENT SERVICE AREA\n\nGhaafeedi Music currently serves customers located in the United States only. Orders from outside the United States will be declined at this time. We will announce international expansion when available.",
          "1.2 RESTRICTED REGIONS\n\nRegardless of service area, we do not accept customers located in:\n• Countries subject to U.S. OFAC sanctions\n• Regions where our services would violate local law\n• Any additional restricted jurisdictions as defined with legal counsel",
        ],
      },
      {
        heading: "SECTION 2 — EUROPEAN CUSTOMERS (GDPR)",
        body: [
          "2.1 GDPR APPLICABILITY\n\nIf we accept customers in the European Economic Area (EEA) or United Kingdom in the future, GDPR and UK GDPR will apply.",
  ...
  "music-rights-strategy": {
    ...
    title: "Music Rights and Licensing Strategy",
    subtitle: "Ghaafeedi Music LLC — Review Every 6 Months (AI Law Evolves Rapidly)",
    effective: "June 27, 2026",
    updated: "June 27, 2026",
    category: "Rights",
    sections: [
      {
        ...
        body: [
          "1.1 ACTIVE LITIGATION TO MONITOR\n\nRIAA v. Suno, Inc. and Udio: Major record labels have sued AI music companies alleging copyright infringement in training data. Settlement or verdict will significantly affect AI music industry. Status: Ongoing as of 2026. Action Required: Monitor and update platform accordingly when resolved.\n\nSony Music v. Various AI Companies: Various suits regarding training data use.\n\nGetty Images v. Stability AI: Visual AI training data case with implications for music AI training data standards.",
  ...
  "nda-ip-assignment": {
    ...
    subtitle: "Ghaafeedi Music LLC — For All Employees, Contractors, and Service Providers",
    effective: "June 27, 2026",
    updated: "June 27, 2026",
    category: "Internal",
    sections: [
...
export default function LegalDoc() {
  ...
  if (!doc) {
    return (
      <div style={{ minHeight: "100vh", background: "#050B1A", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center" }}>
          <h1 style={{ color: "#D4AF37", fontFamily: "Playfair Display, serif", fontSize: 32, marginBottom: 16 }}>Document Not Found</h1>
          <p style={{ color: "#94a3b8", marginBottom: 32 }}>The legal document you're looking for doesn't exist or has been moved.</p>
          <Link href="/legal" style={{ color: "#D4AF37", textDecoration: "none", border: "1px solid #D4AF37", padding: "10px 24px", borderRadius: 8 }}>← Back to Legal Center</Link>
        </div>
      </div>
    );
  }

  const categoryColor = doc.category === "Internal" ? "#F59E0B" : "#D4AF37";
  const categoryLabel = doc.category === "Internal" ? "Internal Document" : doc.category === "Rights" ? "Rights & Licensing" : "Customer Policy";

  return (
    <div style={{ minHeight: "100vh", background: "#050B1A", color: "#fff", fontFamily: "Inter, sans-serif" }}>
      {/* Header */}
      <div style={{ background: "linear-gradient(180deg, #0B1736 0%, #050B1A 100%)", borderBottom: "1px solid rgba(212,175,55,0.15)", padding: "24px 0" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 24px" }}>
          <Link href="/legal" style={{ color: "#D4AF37", textDecoration: "none", fontSize: 14, display: "inline-flex", alignItems: "center", gap: 6, marginBottom: 20 }}>
            ← Back to Legal Center
          </Link>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
            <span style={{ background: `${categoryColor}22`, border: `1px solid ${categoryColor}44`, color: categoryColor, borderRadius: 6, padding: "3px 10px", fontSize: 11, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase" }}>{categoryLabel}</span>
          </div>
          <h1 style={{ fontFamily: "Playfair Display, serif", fontSize: "clamp(22px, 4vw, 34px)", color: "#fff", marginBottom: 8, lineHeight: 1.2 }}>{doc.title}</h1>
          <p style={{ color: "#94a3b8", fontSize: 14 }}>{doc.subtitle} &nbsp;·&nbsp; Effective: {doc.effective} &nbsp;·&nbsp; Last Updated: {doc.updated}</p>
        </div>
      </div>

      {/* Internal warning banner */}
      {doc.category === "Internal" && (
        <div style={{ background: "#451a03", borderBottom: "1px solid #92400e", padding: "12px 24px", textAlign: "center" }}>
          <span style={{ color: "#fcd34d", fontSize: 13, fontWeight: 600 }}>⚠ Internal Document — Not for customer distribution. For Ghaafeedi Music operations only.</span>
        </div>
      )}

      {/* Placeholder warning banner */}
      <div style={{ background: "#1e1b4b", borderBottom: "1px solid #3730a3", padding: "12px 24px", textAlign: "center" }}>
        <span style={{ color: "#a5b4fc", fontSize: 13 }}>Items marked <strong style={{ color: "#f59e0b" }}>⚠️ NEEDS:</strong> require real information from Lawrence before this document is legally final. Search the page for "NEEDS:" to find all gaps.</span>
      </div>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "48px 24px 80px" }}>
        {doc.sections.map((section, si) => (
          <div key={si} style={{ marginBottom: 48 }}>
            <h2 style={{ fontFamily: "Playfair Display, serif", fontSize: 18, color: "#D4AF37", marginBottom: 20, paddingBottom: 10, borderBottom: "1px solid rgba(212,175,55,0.2)" }}>
              {section.heading}
            </h2>
            {section.body.map((para, pi) => (
              <p key={pi} style={{ color: "#cbd5e1", lineHeight: 1.85, marginBottom: 16, fontSize: 14, whiteSpace: "pre-wrap" }}>
                {para}
              </p>
            ))}
          </div>
        ...
        {/* Footer nav */}
        <div style={{ borderTop: "1px solid rgba(212,175,55,0.15)", paddingTop: 32, display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
          <Link href="/legal" style={{ color: "#D4AF37", textDecoration: "none", fontSize: 14 }}>← All Legal Documents</Link>
          <div style={{ fontSize: 12, color: "#64748b" }}>
            Questions? <a href="mailto:legal@ghaafeedimusic.com" style={{ color: "#D4AF37" }}>legal@ghaafeedimusic.com</a>
          </div>
        </div>
      </div>
    </div>
